...
// _src/models/ChallengeModel/index.ts
var ChallengeFeedbackSchema = new Schema5(
  {
...
var ChallengeSettingsSchema = new Schema5(
  {
...
var ChallengeSettingsForeignSchema = new Schema5(
  {
    type: {
      type: String,
...
var ChallengeForeignSchema = new Schema5(
  {
    id: { type: String, required: true },
    name: { type: String, required: true },
    storyline: { type: [String], required: true },
...
var ChallengeSchema = new Schema5(
  {
    name: { type: String, required: true },
...
var ChallengeModel = models4.Challenge || model4("Challenge", ChallengeSchema);
...
// _src/models/QrModel/index.ts
var QrContentSchema = new Schema6(
  {
...
var QrLocationSchema = new Schema6(
  {
...
var QrModel = models5.Qr || model5("Qr", QrSchema);
...
var PeriodeValidator = schema_default.generate({
  startDate: Joi4.date().required().greater("now"),
  endDate: Joi4.date().required().greater(Joi4.ref("startDate"))
});
...
var DefaultListParamsFields = {
  page: Joi6.number().default(1),
  limit: Joi6.number().default(10),
  search: Joi6.string().allow("").default("")
};
