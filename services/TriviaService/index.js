...
var TriviaService_exports = {};
__export(TriviaService_exports, {
  content: () => content,
  default: () => TriviaService_default,
  detail: () => detail3,
  sync: () => sync,
  verify: () => verify3
});
module.exports = __toCommonJS(TriviaService_exports);
...
var transaction = async (operation) => {
  const session = await (0, import_mongoose4.startSession)();
