...
export declare const details: (challengeId: string) => Promise<(import("../../models/TriviaModel").Trivia & {
    _id: import("mongoose").Types.ObjectId;
})[]>;
export declare const sync: (challengeId: string, payload: TriviaPayload[]) => Promise<(import("../../models/TriviaModel").Trivia & {
    _id: import("mongoose").Types.ObjectId;
})[]>;
...
declare const TriviaService: {
    ...
    sync: (challengeId: string, payload: TriviaPayload[]) => Promise<(import("../../models/TriviaModel").Trivia & {
        _id: import("mongoose").Types.ObjectId;
    })[]>;
