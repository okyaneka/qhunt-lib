...
export { QrGenerate, QrUpdate, _delete2 as _delete, qr_service_default as default, deleteMany, detail7 as detail, details5 as details, list3 as list, verify6 as verify };
