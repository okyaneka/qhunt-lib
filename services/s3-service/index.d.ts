...
export declare const S3ServiceSet: (payload: S3Payload, userId: string, session?: ClientSession) => Promise<import("../..").S3 & {
    _id: import("mongoose").Types.ObjectId;
}>;
export declare const S3ServiceGet: (path: string) => Promise<void>;
