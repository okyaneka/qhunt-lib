import { UserStageListParams } from "../..";
import { ClientSession } from "mongoose";
export declare const verify: (stageId: string, TID: string) => Promise<(import("mongoose").Document<unknown, {}, import("../..").UserStage> & import("../..").UserStage & {
    _id: import("mongoose").Types.ObjectId;
} & {
    __v: number;
}) | null>;
export declare const setup: (stageId: string, TID: string) => Promise<(import("../..").UserStage & {
    _id: import("mongoose").Types.ObjectId;
...
export declare const detail: (id: string, TID: string) => Promise<import("../..").UserStage & {
    _id: import("mongoose").Types.ObjectId;
}>;
export declare const submitState: (id: string, TID: string, session?: ClientSession) => Promise<import("../..").UserStage & {
    _id: import("mongoose").Types.ObjectId;
}>;
...
declare const UserStageService: {
    ...
    submitState: (id: string, TID: string, session?: ClientSession) => Promise<import("../..").UserStage & {
        _id: import("mongoose").Types.ObjectId;
    }>;
};
