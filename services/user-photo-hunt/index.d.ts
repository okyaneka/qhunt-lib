...
export declare const submit: (id: string, TID: string, isFound: boolean, bonus?: number) => Promise<import("../../types").UserPhotoHunt & {
    _id: import("mongoose").Types.ObjectId;
}>;
...
declare const UserPhotoHuntService: {
    ...
    readonly submit: (id: string, TID: string, isFound: boolean, bonus?: number) => Promise<import("../../types").UserPhotoHunt & {
        _id: import("mongoose").Types.ObjectId;
    }>;
