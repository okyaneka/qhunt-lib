import { UserChallengeParams, UserChallengeResult, UserChallengeSummary, UserStage, Stage, ChallengeForeign, ChallengeSettingsForeign } from "../..";
import { ClientSession } from "mongoose";
export declare const init: (stage: Stage, userStage: UserStage, session?: ClientSession) => Promise<(import("mongoose").Document<unknown, {}, import("../..").UserChallenge> & import("../..").UserChallenge & {
    _id: import("mongoose").Types.ObjectId;
} & {
    __v: number;
})[]>;
export declare const setup: (challengeId: string, TID: string, setDiscover?: boolean) => Promise<import("../..").UserChallenge & {
    _id: import("mongoose").Types.ObjectId;
}>;
...
export declare const detail: (id: string, TID: string) => Promise<import("../..").UserChallenge & {
    _id: import("mongoose").Types.ObjectId;
}>;
export declare const submit: (id: string, TID: string, session?: ClientSession, forceFinish?: boolean) => Promise<import("../..").UserChallenge & {
    _id: import("mongoose").Types.ObjectId;
}>;
...
declare const UserChallengeService: {
    ...
    readonly submit: (id: string, TID: string, session?: ClientSession, forceFinish?: boolean) => Promise<import("../..").UserChallenge & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    readonly summary: (userStageId: string, TID: string, session?: ClientSession) => Promise<UserChallengeSummary[]>;
    readonly init: (stage: Stage, userStage: UserStage, session?: ClientSession) => Promise<(import("mongoose").Document<unknown, {}, import("../..").UserChallenge> & import("../..").UserChallenge & {
        _id: import("mongoose").Types.ObjectId;
    } & {
        __v: number;
    })[]>;
