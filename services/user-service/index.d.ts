import { UserListParams, UserPayload, UserPublicPayload, S3Payload, UserProvider, UserLoginPayload, UserForeignFull, UserPasswordPayload } from "../../index";
import { ClientSession } from "mongoose";
import { User as FirebaseUser } from "firebase/auth";
export declare const register: (payload: UserPayload, TID: string) => Promise<import("../../index").User & {
    _id: import("mongoose").Types.ObjectId;
}>;
export declare const googleSign: (payload: FirebaseUser, TID: string) => Promise<(import("../../index").User & {
    _id: import("mongoose").Types.ObjectId;
}) | undefined>;
...
export declare const update: (id: string, payload: UserPublicPayload) => Promise<import("../../index").UserPublic & {
    _id: import("mongoose").Types.ObjectId;
}>;
export declare const updatePassword: (id: string, payload: UserPasswordPayload) => Promise<{}>;
export declare const updatePhoto: (userId: string, payload: S3Payload) => Promise<import("../../index").UserPublic & {
    _id: import("mongoose").Types.ObjectId;
}>;
...
declare const UserService: {
    register: (payload: UserPayload, TID: string) => Promise<import("../../index").User & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    googleSign: (payload: FirebaseUser, TID: string) => Promise<(import("../../index").User & {
        _id: import("mongoose").Types.ObjectId;
    }) | undefined>;
    ...
    update: (id: string, payload: UserPublicPayload) => Promise<import("../../index").UserPublic & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    updatePassword: (id: string, payload: UserPasswordPayload) => Promise<{}>;
    updatePhoto: (userId: string, payload: S3Payload) => Promise<import("../../index").UserPublic & {
        _id: import("mongoose").Types.ObjectId;
    }>;
