...
var list = async (params) => {
  ...
  const list2 = await challenge_default.find(filter).skip(skip).limit(params.limit).sort({ createdAt: -1 });
...
export { _delete, create, challenge_default2 as default, detail2 as detail, list, update, updateContent, verify };
