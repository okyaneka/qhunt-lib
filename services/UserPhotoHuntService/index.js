...
var UserPhotoHuntService_exports = {};
__export(UserPhotoHuntService_exports, {
  default: () => UserPhotoHuntService_default,
  details: () => details3,
  setup: () => setup2,
  submit: () => submit,
...
module.exports = __toCommonJS(UserPhotoHuntService_exports);
...
// _src/models/PhotoHuntModel/index.ts
var PhotoHuntForeignSchema = new import_mongoose4.Schema(
  {
    id: { type: String, required: true },
...
var PhotoHuntSchema = new import_mongoose4.Schema(
  {
...
var PhotoHuntModel = import_mongoose4.models.PhotoHunt || (0, import_mongoose4.model)("PhotoHunt", PhotoHuntSchema, "photoHunts");
...
var StageSettingsSchema = new import_mongoose8.Schema(
  {
...
var StageSettingsForeignSchema = new import_mongoose8.Schema(
  {
    periode: { type: PeriodSchema, required: true }
  },
  { _id: false }
);
var StageForeignSchema = new import_mongoose8.Schema(
  {
    id: { type: String, required: true },
    name: { type: String, required: true },
    storyline: { type: [String], required: true },
...
var StageSchema = new import_mongoose8.Schema(
  {
    name: { type: String, required: true },
...
var StageModel = import_mongoose8.models.Stage || (0, import_mongoose8.model)("Stage", StageSchema);
...
// _src/models/UserPhotoHuntModel/index.ts
var UserPhotoHuntResultSchema = new import_mongoose11.Schema(
  {
...
var UserPhotoHuntSchema = new import_mongoose11.Schema({
...
var UserPhotoHuntModel = import_mongoose11.models.UserPhotoHunt || (0, import_mongoose11.model)("UserPhotoHunt", UserPhotoHuntSchema, "usersPhotoHunt");
...
var TriviaOptionSchema = new import_mongoose12.Schema(
  {
...
var TriviaForeignOptionSchema = new import_mongoose12.Schema(
  {
    text: { type: String, required: true }
  },
  { _id: false }
);
var TriviaForeignSchema = new import_mongoose12.Schema(
  {
    id: { type: String, required: true },
...
var TriviaSchema = new import_mongoose12.Schema(
  {
    challenge: { type: IdNameSchema, default: null },
    question: { type: String, required: true },
...
var TriviaModel = import_mongoose12.models.Trivia || (0, import_mongoose12.model)("Trivia", TriviaSchema);
...
var UserTriviaResultSchema = new import_mongoose13.Schema(
  {
...
var UserTriviaSchema = new import_mongoose13.Schema(
  {
    userPublic: { type: UserPublicForeignSchema, required: true },
    userChallenge: { type: UserChallengeForeignSchema, required: true },
...
var UserTriviaModel = import_mongoose13.models.UserTrivia || (0, import_mongoose13.model)("UserTrivia", UserTriviaSchema, "usersTrivia");
