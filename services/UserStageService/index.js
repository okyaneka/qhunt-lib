...
// _src/models/ChallengeModel/index.ts
var ChallengeSettingsSchema = new import_mongoose7.Schema(
  {
    type: {
      type: String,
...
var ChallengeSettingsForeignSchema = new import_mongoose7.Schema(
  {
    type: {
      type: String,
      enum: Object.values(ChallengeTypeValues),
...
var ChallengeForeignSchema = new import_mongoose7.Schema(
  {
    id: { type: String, required: true },
    name: { type: String, required: true },
    storyline: { type: [String], required: true },
...
var ChallengeSchema = new import_mongoose7.Schema(
  {
    name: { type: String, required: true },
...
var ChallengeModel = import_mongoose7.models.Challenge || (0, import_mongoose7.model)("Challenge", ChallengeSchema);
