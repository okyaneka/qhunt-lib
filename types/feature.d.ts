...
export type FeatureListParams = Pick<Feature, "type" | "status"> & DefaultListParams & {
    questId: string;
};
export type FeatureStatus = ValueOf<typeof FEATURE_STATUS>;
export type FeatureType = ValueOf<typeof FEATURE_TYPES>;
export type FeaturePayload = Pick<Feature, "title" | "content" | "status" | "type" | "slug" | "attachments" | "featured"> & {
    questId: string | null;
    featuredImage: S3Payload | null;
};
